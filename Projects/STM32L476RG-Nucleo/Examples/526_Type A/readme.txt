This example only supports TypeA communication. This example only supports TypeA communication. It allows to get typeA card's UID and send APDU. The user button is pressed to allow to enter into low power mode.  
...
1. Please download the source code on the ST website(ST account needed):
