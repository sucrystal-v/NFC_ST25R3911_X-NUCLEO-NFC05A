This example only supports TypeB communication. It allows to get typeB card's UID and send APDU. The user button is pressed to allow to enter into low power mode.  
